...
print()
INFO_PATH = "/home/data/"   # 帐号密码和谷歌浏览器驱动目录，相对绝对都OK
successnum = 0
num = 0
...
if __name__ == '__main__':
    ...
    for i1 in range(len(allData)):
        allData[i1] = re.sub(r'(?<="2d4135d558f849e18a5dcc87b884cce5":").*?(?=")', r'{}'.format(t), allData[i1])
        allData[i1] = re.sub(r'(?<="c77d35b16fb22ec70a1f33c315141dbb":").*?(?=")', r'{}'.format(t1), allData[i1])
    with open(INFO_PATH + "data.txt", encoding="utf-8", mode='w') as f:
        allData = [line + '\n' for line in allData]
        ...
        try:
            ...
            for i in all_task["data"]:
                ...
                if task_detail["WFId"] != yb.WFId:
                    if task_detail["WFId"] == '9414723b2ccea68816a11ce3d455496f':
                        break
                    print("表单已更新,得更新程序了")
                    exit()
